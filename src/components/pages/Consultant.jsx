...
const Consultant = () => {
  ...
  const ConsultantCard = ({ _id, name, profileImage, experience, price }) => (
      ...
      <div className="p-4">
        ...
        <div className="flex flex-wrap items-center my-4 gap-3 text-gray-600 text-xs sm:text-sm">
          <div className="flex items-center">
            ...
            <span className="ml-1">
              {experience ? `${experience} বছর` : "অভিজ্ঞতা নেই"}
            </span>
          </div>
          <div className="flex items-center">
            <img src={priceIcon} alt="" className="w-4 h-4" />
            <span className="ml-1">
              {price ? `${price} টাকা` : "নির্ধারিত নেই"}
            </span>
          </div>
        </div>
        ...
        <div className="flex gap-2.5">
          <button
            ...
            onClick={() => navigate(`/consultants/${_id}`)}
          >
            বুক দিন
          </button>
        </div>
