  ...
  return (
    <div style={cal.wrap}>
      ...
      <div style={cal.legend}>
        <span style={cal.legendItem}>
          <span style={{ ...cal.dot, background: "#7ED957" }} /> Available
        </span>
        <span style={cal.legendItem}>
          <span style={{ ...cal.dot, background: "#ef4444" }} /> Booked
        </span>
        <span style={cal.legendItem}>
          <span style={{ ...cal.dot, background: "#f59e0b" }} /> Selected
        </span>
        <span style={cal.legendItem}>
          <span style={{ ...cal.dot, background: "#d1d5db" }} /> Past
        </span>
      </div>
    </div>
  );
...
const cal = {
  ...
  navBtn: {
    background: "#e8f8de", border: "none", borderRadius: 8,
    width: 34, height: 34, cursor: "pointer", fontSize: 20,
    color: "#5cb83a", fontWeight: 700, lineHeight: 1,
  },
  ...
  dayName: {
    ...
    color: "#888", padding: "4px 0", textTransform: "uppercase",
  },
  cell: {
...
const SurveyorsDetails = () => {
  ...
  const fetchSurveyor = async () => {
    ...
    try {
      ...
      try {
        ...
        console.log("Booked dates fetched:", res.data);
  ...
  if (loading) {
    return (
      <div className="flex items-center justify-center min-h-screen">
        ...
        <style>{`
          .loader { border-top-color: #7ED957; animation: spin 1s linear infinite; }
  ...
  const hiddenFields = [
    ...
    "_id","mobile","approvals","role","licenseNumber","training","bookedDates",
  ];
  const fieldLabels = {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-12 py-12">
        ...
        {/* ── TOP: Image + Surveyor Info side by side ── */}
          ...
          {selectedDate && (
            <div
              style={{
                ...
                padding: "12px 16px", background: "#e8f8de",
                borderRadius: 12, color: "#5cb83a",
                fontSize: 14, textAlign: "center",
                border: "1px solid #7ED957", fontWeight: 600,
              }}
            >
              ✓ নির্বাচিত তারিখ:{" "}
