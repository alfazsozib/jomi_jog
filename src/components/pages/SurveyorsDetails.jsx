  ...
  return (
    <div style={cal.wrap}>
      ...
      <div style={cal.header}>
        <button style={cal.navBtn} onClick={prev}>
          ‹
        </button>
        <span style={cal.monthLabel}>
          {MONTHS[cur.month]} {cur.year}
        </span>
        <button style={cal.navBtn} onClick={next}>
          ›
        </button>
      </div>
      ...
      <div style={cal.legend}>
        <span style={cal.legendItem}>
          <span style={{ ...cal.dot, background: "#7ED957" }} /> পাওয়া যাচ্ছে
        </span>
        <span style={cal.legendItem}>
          <span style={{ ...cal.dot, background: "#ef4444" }} /> বুকড
        </span>
        <span style={cal.legendItem}>
          <span style={{ ...cal.dot, background: "#f59e0b" }} /> নির্বাচিত
        </span>
        <span style={cal.legendItem}>
          <span style={{ ...cal.dot, background: "#d1d5db" }} /> অতীত
        </span>
      </div>
    </div>
  );
    ...
    try {
      ...
      try {
        const res = await axios.get(
          `https://jomijog.com/api/users/${id}/booked-dates`,
        );
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-12 py-12">
        ...
        <div className="mt-10 bg-white p-8 rounded-2xl shadow-lg">
          ...
          <p className="text-sm text-gray-500 mb-6">
            সবুজ = পাওয়া যাচ্ছে &nbsp;|&nbsp; লাল = বুকড &nbsp;|&nbsp; হলুদ =
            নির্বাচিত &nbsp;|&nbsp; ধূসর = অতীত
          </p>
